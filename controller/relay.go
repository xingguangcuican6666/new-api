...
func processChannelError(c *gin.Context, channelError types.ChannelError, err *types.NewAPIError, channelSettings *dto.ChannelOtherSettings, allowRuntimeDisable bool) {
		...
		if !taskErr.LocalError {
			...
			processChannelError(c,
				*types.NewChannelError(channel.Id, channel.Type, channel.Name, channel.ChannelInfo.IsMultiKey,
				...
				types.NewOpenAIError(taskErr.Error, types.ErrorCodeBadResponseStatusCode, taskErr.StatusCode), &channelSettings, true)
		}
